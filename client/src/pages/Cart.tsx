                        ...
                        {items.map((item) => (
                            ...
                            >
                                <Link to={`/products/${item.slug}`} className="shrink-0">
                                    <img src={item.image || 'https://via.placeholder.com/100'} alt={item.name} className="w-24 h-24 rounded-xl object-cover" />
                                </Link>
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex items-center justify-between mt-3">
                                        <div className="flex items-center rounded-xl overflow-hidden" style={{ border: '1px solid var(--border-color)' }}>
                                            <button onClick={() => updateQuantity(item.productId, item.quantity - 1)} className="p-2 hover:bg-surface-100 dark:hover:bg-surface-700 transition">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <button onClick={() => removeFromCart(item.productId, item.name)} className="p-2 text-danger-500 hover:bg-red-50 dark:hover:bg-surface-700 rounded-lg transition">
                ...
                <div>
                    <div className="sticky top-24 p-6 rounded-2xl space-y-4" style={{ backgroundColor: 'var(--bg-card)', border: '1px solid var(--border-color)' }}>
                        ...
                        <div className="space-y-3 pt-2" style={{ borderTop: '1px solid var(--border-color)' }}>
                            ...
                            <div className="flex justify-between text-sm"><span style={{ color: 'var(--text-secondary)' }}>Tax (5%)</span><span className="font-medium">{currencySymbol}{taxAmount.toFixed(2)}</span></div>
